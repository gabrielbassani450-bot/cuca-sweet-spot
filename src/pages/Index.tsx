  ...
  return <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-40 border-b bg-background/80 backdrop-blur">
        <div className="container flex h-16 items-center justify-between">
          ...
          <a href={WHATSAPP_LINK} target="_blank" rel="noreferrer" className="hidden rounded-full bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground shadow-soft transition-transform hover:scale-[1.02] active:scale-[0.98] sm:inline-flex">
            Pedir no WhatsApp
          </a>
        </div>
      </header>
        ...
        <section className="bg-hero">
          <div className="container grid items-center gap-8 py-10 sm:py-14 lg:grid-cols-12">
            <div className="lg:col-span-6">
              <h1 className="text-balance text-4xl font-bold tracking-tight text-foreground sm:text-5xl">Cucas e biscoitos caseiros para adoçar seu dia</h1>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <a href="#cardapio" className="inline-flex items-center justify-center rounded-full bg-primary px-5 py-3 text-sm font-semibold text-primary-foreground shadow-soft">
                  Ver cardápio
                </a>
                <a href={WHATSAPP_ORDER_LINK} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center rounded-full border bg-background px-5 py-3 text-sm font-semibold text-foreground">
                  Fazer pedido
                </a>
              </div>
              ...
              <Card className="overflow-hidden shadow-soft">
                <div className="grid gap-0 sm:grid-cols-2">
                  <div className="relative aspect-[4/3] max-h-72 sm:aspect-auto sm:h-full sm:max-h-none">
                    <img src={heroPhoto} alt="Foto da cozinheira responsável pelas cucas" className="h-full w-full object-cover object-top" loading="lazy" />
                  </div>
                  <div className="p-5">
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5">
              <Card className="p-6 shadow-soft">
                ...
                <a href={WHATSAPP_LINK} target="_blank" rel="noreferrer" className="mt-5 inline-flex w-full items-center justify-center rounded-full bg-primary px-5 py-3 text-sm font-semibold text-primary-foreground shadow-soft">
                  Chamar no WhatsApp
                </a>
              </Card>
            </div>
